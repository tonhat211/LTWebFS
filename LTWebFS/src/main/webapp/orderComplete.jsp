...
<head>
    ...
    <title>Quản lý đơn hàng - Xác nhận hoàn thành</title>
...
<main id="main" class="main" style="margin-left: 180px">
    <div class="ad-content" style="flex-direction: column">
        <h2 style="text-align: center">Xác nhận hoàn thành đơn hàng</h2>
            ...
            <div class="show-flex-row" style="width: 100%; align-items: center; justify-content: space-between;">
                ...
                <div>
                    <form class="ad_find-container" action="update-order" id="updateOrderForm" method="post" style="width: 200px;">
                        ...
                        <input type="text" placeholder="Nhập id don hang" class="ad_find-input" name="action" value="complete" hidden readonly>
                    </form>
                </div>
...
<%--        <script> showInfoToast2("hi");</script>--%>
        ...
        <table class="table" style="width: 100%;">
            ...
            <tbody class="order-info-container">
                <%=(orders.isEmpty()?"<p>Không có đơn hàng có thể xác nhận hoàn thành</p>":"")
                %>
...
//                    System.out.println(item.getKey() + " - " + item.getValue());
            ...
            <tr class="<%= (i%2==0) ? "roww": ""%>">
                ...
                <td><button class="btn_confirm_order complete" onclick="updateOrder('complete',<%=item.getKey().getId()%>);">Hoàn thành</button> </td>
