...
<%--                            </div>--%>
                            ...
                            <div class="disabled-showing <%= (pu.getAvailable()==0?"active":"") %>" style="right: 0; left: 100px">
                                <div class="disabled-showing-content">
                                    NGƯNG BÁN
                                </div> </div>
                        </div>
                        <div class="stop_reSale <%= (pu.getName()==""?"hide":"") %>" >
                            <div class="btn btn-stop-pro <%= (pu.getAvailable()==1?"active":"") %>">Dừng bán</div>
                            <div class="btn btn-resale-pro <%= (pu.getAvailable()==0?"active":"") %>"><a class="no-a"
                                    href="addUpdate-product?action=resale&id=<%=pu.getId()%>">Bán lại</a></div>
